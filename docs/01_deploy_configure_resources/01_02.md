...
- [How to create and configure your storage account for use in Microsoft Foundry Projects (classic)](https://learn.microsoft.com/azure/foundry-classic/how-to/evaluations-storage-account)
