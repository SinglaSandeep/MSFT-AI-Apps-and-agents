...
- Optional access to Microsoft 365 Copilot, Copilot Studio, Azure API Management, and Logic Apps connectors if your session includes the low-code, AI Gateway, and custom MCP tool sections from the expanded agenda.
